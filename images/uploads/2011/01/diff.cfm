...
<cfoutput>
	<h1>FarCry / MySQL Diff Utility</h1>
</cfoutput>
...
<cfif len(form.infoSchema)>
	...
	<cfoutput>
		<p>Currently running against <em>#form.infoSchema#</em>, <a href="customadmin.cfm?module=learnosity/diff.cfm">run against another schema</a></p>
		<hr>
	</cfoutput>
...
<cfelse>
	...
	<cfoutput>
		<p>Looks for differences in case between MySQL table names, and the relevant references in the FarCry coapi.
		<br />Also looks for missing tables in either FarCry or MySQL.</p>
